...
int main( void )
{
	...
	GLuint programID = LoadShaders( "SimpleTransform.vert", "ColourShader.frag" );
	...
	// we could modify this directly, but instead we will transform once more
	glm::mat4 Model      = glm::mat4(1.0f);
	
	// Translate the model
	glm::mat4 CUBEModel      = glm::translate(Model, glm::vec3(1.0f, 0.0f, 2.0f));
	
	
	// Our ModelViewProjection : multiplication of our 3 matrices
	glm::mat4 CUBEMVP        = Projection * View * CUBEModel; // Remember, matrix multiplication is the other way around

	mat4 TRIANGLEModelTransform      = glm::translate(Model, glm::vec3(-6.0f, -2.0f, 2.0f));
	mat4 TRIANGLEModel = glm::rotate(TRIANGLEModelTransform, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
	glm::mat4 TRIANGLEMVP    = Projection * View * TRIANGLEModel; // Remember, matrix multiplication is the other way around
	...
	do{
		...
		glVertexAttrib3f(1, 1.0f, 0.0f, 0.0f);  // Red color for the triangle
