...
void computeMatricesFromInputs() {
	...
	static float angleY = 0.0f; // Angle for Y rotation

	angleX += 30.0f * deltaTime; // X-axis rotation speed
	angleY += 45.0f * deltaTime; // Y-axis rotation speed
	...
	// Combine rotations
	ModelMatrix = rotationY * rotationX; // Y rotation first, then X rotation
